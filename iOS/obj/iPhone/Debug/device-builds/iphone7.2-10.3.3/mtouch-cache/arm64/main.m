...
extern void *mono_aot_module_FormsBiometric_iOS_info;
...
extern void *mono_aot_module_FormsBiometric_info;
...
extern void *mono_aot_module_Plugin_Fingerprint_Abstractions_info;
...
{
	mono_aot_register_module (mono_aot_module_FormsBiometric_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_FormsBiometric_info);
	...
	mono_aot_register_module (mono_aot_module_Plugin_Fingerprint_Abstractions_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "FormsBiometric.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
