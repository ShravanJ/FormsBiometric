package md5cd42f6d72bf05f50197800f6ea586bee;


public class TaskAnimationListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.Fingerprint.Utils.TaskAnimationListener, Plugin.Fingerprint, Version=1.4.5.0, Culture=neutral, PublicKeyToken=null", TaskAnimationListener.class, __md_methods);
	}


	public TaskAnimationListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == TaskAnimationListener.class)
			mono.android.TypeManager.Activate ("Plugin.Fingerprint.Utils.TaskAnimationListener, Plugin.Fingerprint, Version=1.4.5.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
